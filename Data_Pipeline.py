from Ingestion import ArxivIngestor
...
class DataPipeline:
    ...
    def __init__(self, base_dir="arxiv_papers", topic="machine learning", max_results=10):
        """
        Initialize the data pipeline with optional parameters.

        Args:
            base_dir (str, optional): Folder to store pipeline outputs.
        ...
        self.ingestor = ArxivIngestor(base_dir, topic, max_results)
    ...
    def run(self):
        ...
        return {
            "metadata_path": "arxiv_papers/metadata.json",
            "extracted_path": "arxiv_papers/extracted_content.json",
            "chunked_path": "arxiv_papers/chunked_dataset_scibert.json",
