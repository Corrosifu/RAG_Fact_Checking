...
class Evaluation:
    ...
    def __init__(
        ...
        chunked_dataset_path: str = "arxiv_papers/chunked_dataset_scibert.json"
    ):
        """
        ...
        Parameters
        ----------
        faiss_index_path : str, optional
            Path to FAISS index directory. Default is "faiss_index".
        chunked_dataset_path : str, optional
            Path to the preprocessed SciBERT chunked dataset.
        """
