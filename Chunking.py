...
class SciBERTChunker:
    ...
    def run(self, json_path="arxiv_papers/extracted_content.json", output_file="arxiv_papers/chunked_dataset_scibert.json"):
        """
        ...
        self.save_chunked_dataset(chunked_data, output_file)
        return chunked_data
